...
exports.assertMultiple = exports.assertRangeOrUndefined = exports.assertRange = exports.assertEachIs = exports.assertOrUndefined = exports.assertIs = exports.createTypeErrorMsg = exports.isType = exports.getType = exports.assertIsOneOfOrUndefined = exports.assertIsOneOf = exports.createValueErrorMsg = exports.singleQuote = exports.backtick = void 0;
var utils_1 = require("./");
...
exports.createValueErrorMsg = function (value, valueName, values) {
    ...
    for (var idx = 0, len = values.length; idx < len; idx++) {
        ...
        var type = typeof v;
        if (type === 'string')
            allowedValues[idx] = exports.singleQuote(v);
        else if (type === 'undefined')
            allowedValues[idx] = exports.backtick('undefined');
        else
            allowedValues[idx] = v;
    }
    var joinedValues = allowedValues.join(' or ');
    // prettier-ignore
    return exports.backtick(valueName) + " must be one of " + joinedValues + ", but was actually " + value;
};
exports.assertIsOneOf = function (value, valueName, values) {
    if (!Array.isArray(values))
        values = utils_1.values(values);
    for (var idx = 0, len = values.length; idx < len; idx++) {
        if (value === values[idx])
            return;
    }
    throw new TypeError(exports.createValueErrorMsg(value, valueName, values));
};
exports.assertIsOneOfOrUndefined = function (value, valueName, values) {
    if (!Array.isArray(values))
        values = utils_1.values(values);
    exports.assertIsOneOf(value, valueName, values.concat(undefined));
};
